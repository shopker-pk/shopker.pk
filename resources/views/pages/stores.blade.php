...
<body>
      ...
      @include('layouts.messages')
            ...
            <div class="container" style="margin-bottom: 100px;margin-top: 20px;">
                <div class="row">
                    <div class="col-md-3">
                        <div class="vendorlogo" align="center">
                            <img src="{{ $store_details[0]['store_logo'] }}" style="margin-top:35%;" width="200" height="100" align="{{ $store_details[0]['store_logo_alt'] }}">
                        </div>
                    </div>
                    <div class="col-md-9">
                        <div class="vendorbanner">
                            <img src="{{ $store_details[0]['store_banner'] }}" width="100%" alt="{{ $store_details[0]['store_banner_alt'] }}">
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="col-md-4">
                        <div style="font-size: 19px; color: white; margin-top: 40px;"><span style=" padding: 3px; background-image: linear-gradient(to left,green,black);">{{ explode(' ', $store_details[0]['store_name'])[0] }}</span><span style="padding: 3px; background-image: linear-gradient(to right,red,black);"> {{ explode(' ', $store_details[0]['store_name'])[1] }}</span></div>
                    </div>
                ...
                <section id="service">
                    <div class="row" style="margin-top: 10px;">
                        <div class="col-md-2 mt-3" style="padding: 0px;">
                            <div class="" id="sortby" style="border:1px solid #ccc; padding-left: 9px; padding-right: 9px;">
                                <h4 class="text-uppercase">Sort By</h4>
                                <hr/>
                                ...
                                <div class="col">
                                    <div class="container-fluid">
                                        <div class="row" style="margin-top: 10px; margin-bottom: 20px;">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-3 imgcolslider">
